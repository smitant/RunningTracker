...
namespace RunningTracker.Data.Migrations
{
    ...
    [Migration("20161210192724_[DataEntryViewModel]")]
    partial class DataEntryViewModel
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("RunningTracker.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RunningTracker.Models.ApplicationUser")
                        .WithMany("Claims")
